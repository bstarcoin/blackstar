...
#if defined(NDEBUG)
# error "Blackstar cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Blackstar Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(pindexPrev->nHeight > 14500)
        nSubsidy = nCoinAge * COIN_YEAR_REWARDtwo / 365;
...
{
    RenameThread("blackstar-loadblk");
